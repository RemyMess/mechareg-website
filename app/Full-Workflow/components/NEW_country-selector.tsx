...
export const COUNTRIES: SelectMenuOption[] = Object.keys(ALL_REGULATORY_INFOS).map((key) => ({
    title: ALL_REGULATORY_INFOS[key].fullName,
    value: key,
}));
...
export default function CountrySelector({
    ...
    useEffect(() => {
        ...
        const handleClickOutside = (event: MouseEvent) => { // Explicitly type the event parameter
